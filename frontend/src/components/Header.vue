...
export default {
  ...
  computed: {
    ...
    logo() {
      let c = "data:image/svg+xml;base64,"
      if (!this.theme) {
        c = "data:image/svg+xml;base64,"
      }
      return c
    },
    backStyle() {
